    ...
    <div class="filter-taxonomies">
        <div class="sorting span4">
			<span data-filter="sort" data-filtervalue="recent" class="active">
				<a href="<?php get_bloginfo('home') ?>/operatori?recent=DESC">I più recenti</a>
			</span>
            <span>|</span>
			<span data-filter="sort" data-filtervalue="alfabet">
				<a href="<?php echo get_bloginfo('home') ?>/operatori?alfa=ASC">In ordine alfabetico</a>
			</span>
        </div>
        <?php $terms = get_terms("categoria_operatore"); ?>
        <ul class="span7">
            <?php foreach ( $terms as $term ) { ?>
                <li>
                    <a href="<?php echo get_term_link($term->slug, 'categoria_operatore' ); ?>"><?php echo $term->name; ?></a>
                </li>
            <?php } ?>
        </ul>
        <div class="clear"></div>
