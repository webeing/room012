<?php
/*
* Template name: Enti e Associazioni
*/
get_header();
...
R012Utility::r012_advanced_search_form('r012_ricerca_enti', $_POST);
?>
    ...
    <div class="filter-taxonomies">
        ...
        <div class="sorting span4">
                <span data-filter="sort" data-filtervalue="recent" class="active">
                    <a href="<?php get_bloginfo('home') ?>/enti-e-associazioni?recent=DESC">I più recenti</a>
                </span>
            <span>|</span>
                <span data-filter="sort" data-filtervalue="alfabet">
                    <a href="<?php echo get_bloginfo('home') ?>/enti-e-associazioni?alfa=ASC">In ordine alfabetico</a>
                </span>
        </div>
        <?php } ?>
    ...
    <?php if($_POST){
        ...
        <div class="feedback-ricerca">
            <ul class="alert">
                ...
                <?php if($_POST["r012_categorie_ente"]){
                    $categorie = $_POST['r012_categorie_ente'];
                    foreach ($categorie as $categoria){
                        $nome_categoria = get_term_by('id', $categoria, 'categoria_ente');
