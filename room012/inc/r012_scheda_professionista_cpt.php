    ...
    /**
        ...
        public function r012_print_custom_box_scheda( $post ) {
            ...
            foreach ($province as $key => $value) {
                if($value == $r012_value_provincia_ordine){
...
<?php }
    ...
    ?>
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="anagraficabase">
                            ...
                            <li>
                                ...
                                <label for="r012_junior_saved" class="span3">esperienza
                                <?php $r012_value_junior = get_post_meta( $postid, 'r012_junior_saved', true); ?>
                                <select name="r012_junior_saved" placeholder="Grado d'esperienza">';

                                    <?php if ($r012_value_junior == 0){?>
                                        <option value="0" selected>Grado d'esperienza</option>
                                    <?php } else {?>
                                        <option value="0">Grado d'esperienza</option>
                                    <?php } ?>
                                    <?php if ($r012_value_junior == 1){?>
                                        <option value="1" selected>Junior</option>
                                    <?php } else {?>
                                        <option value="1">Junior</option>
                                    <?php } ?>
                                    <?php if ($r012_value_junior == 2){?>
        ...
        <p class="professione">
            <strong><?php $terms = get_the_terms($postid, 'categorie_professionisti');
                $r012_value_junior = get_post_meta($postid, 'r012_junior_saved', true);
                if($r012_value_junior==1){
                    $r012_print_junior = 'jr';
                }
                foreach ( $terms as $term ) {
                    echo $term->name . ' ' . $r012_print_junior;
    ...
    public function r012_load_dati_bionote($postid, $user_ID){?>
            ...
            <div class="span12">
                ...
                <?php if (get_post_field('post_content', $postid) || $user_ID){ ?>
                <h4 class="title-profile">note biografiche</h4>
