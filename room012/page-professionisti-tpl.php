...
if($_POST){
    ...
    R012Utility::r012_advanced_search_form('r012_ricerca_professionisti', $_POST);
?>
    <div class="filter">
            ...
            <div class="feedback-ricerca">
                <ul class="alert">
                    ...
                    <?php if($_POST['r012_name_search']){
                        echo '<li>' . $_POST['r012_name_search'] . ' ';
                    } ?>
                    <?php if($_POST['r012_last_name_search']){
                        echo  $_POST['r012_last_name_search'] . '</li>';
                    } ?>

                    <?php if($_POST['r012_categorie_professionista']){
                        $categorie = $_POST['r012_categorie_professionista'];
                        foreach ($categorie as $categoria){
                            $nome_categoria = get_term_by('id', $categoria, 'categorie_professionisti');
                            echo '<li>' . $nome_categoria->name . '</li>';
                        }
                    } ?>


                    <?php if($_POST['r012_attivita_item']){
                        $attivita = $_POST['r012_attivita_item'];
                        foreach ($attivita as $attivita){
                            $nome_attivita = get_term_by('id', $attivita, 'attivita_professionisti');
                            echo '<li>' . $nome_attivita->name . '</li>';
                        }
                    } ?>
    ...
    while ( have_posts() ) : the_post();?>
        <?php
            $r012_nome = get_post_meta($post->ID, "r012_nome_saved", true);
        ...
        <article class="span2">
            ...
            <span>
                ...
                if($r012_value_junior){
                    $r012_print_junior = 'jr';
                }
                echo $r012_term[0]->name . ' ' . $r012_print_junior;?>  | <?php echo get_post_meta($post->ID,'r012_provincia_saved',true); ?>
            </span>
            </div>
        </article>
