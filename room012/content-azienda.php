...
?>
    ...
    <div class="testobio span7">
            ...
            <ul id="anagraficabase">
                <?php  $terms = get_the_terms($post->ID, 'categoria_azienda');
                if($terms){
                ?>
                <li>

                    settore merceologico <strong>
                        <?php
            ...
            <br class="clear"/>
        <?php if(R012Gallery::r012_gallery( $post->ID )){?>
        <section class="gallery row-fluid">
            <div class="span12">
                <h4 class="title-profile">Galleria Azienda</h4>
        ...
        <?php if(get_the_content()){?>
            <section class="bio row-fluid">
              <div class="span12">
                    <h4 class="title-profile">storia aziendale</h4>
        ...
        <?php if(get_post_meta( $post_id, 'r012_galleria_saved', true)){ ?>
            <section class="project">
                ...
                <h4 class="title-profile">prodotti</h4>
                <?php R012Gallery::r012_gallery( $post->ID ); ?>
            </section>
        <?php } ?>
