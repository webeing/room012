...
get_header();?>
    ...
    <form id="r012_register_form" name="r012_register_form" method="post" enctype="multipart/form-data" novalidate="novalidate" class="form-horizontal">
        ...
        <fieldset>
            ...
            <p class="control-group span5">
                <label for="r012_esperienza"><?php _e("Esperienza ", 'r012' ); ?></label>
                <select name="r012_esperienza" id="r012_esperienza_id">
            ...
            <p class="control-group span5">
                <label for="r012_citta_id"><?php _e("Città", 'r012' ); ?> <small>[*]</small></label>
            ...
            <p class="control-group span5">
                <label for="r012_provincia"><?php _e("Regione", 'r012' ); ?><small>[*]</small></label>
                <?php
                global $regioni;
