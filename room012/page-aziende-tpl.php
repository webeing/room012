...
R012Utility::r012_advanced_search_form('r012_ricerca_aziende', $_POST);
?>
    ...
    <?php if($_POST){
        ...
        <div class="feedback-ricerca">
            <ul class="alert">
                ...
                <?php if($_POST["r012_categorie_azienda"]){
                    $categorie = $_POST['r012_categorie_azienda'];
                    foreach ($categorie as $categoria){
                        $nome_categoria = get_term_by('id', $categoria, 'categoria_azienda');
